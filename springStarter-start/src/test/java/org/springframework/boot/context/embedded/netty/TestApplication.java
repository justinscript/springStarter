...
/**
 * A {@link org.springframework.boot.SpringApplication} harness for integration tests. </p> Implemented in Java to avoid
 * currency issues caused by repeated annotation scanning of Groovy controllers.
 * 
 * @author zxc Mar 1, 2016 10:35:13 AM
 */
@Controller
